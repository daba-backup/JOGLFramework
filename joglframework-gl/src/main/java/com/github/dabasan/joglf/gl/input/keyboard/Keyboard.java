...
public class Keyboard implements KeyListener {
	...
	private final CountsAndFlags alphabet_keys;
	private final CountsAndFlags arrow_keys;
	private final CountsAndFlags function_keys;
	private final CountsAndFlags num_keys;
	private final CountsAndFlags numpad_keys;

	private final CountsAndFlags alt_key;
	private final CountsAndFlags at_key;
	private final CountsAndFlags back_slash_key;
	private final CountsAndFlags back_space_key;
	private final CountsAndFlags colon_key;
	private final CountsAndFlags comma_key;
	private final CountsAndFlags ctrl_key;
	private final CountsAndFlags delete_key;
	private final CountsAndFlags enter_key;
	private final CountsAndFlags escape_key;
	private final CountsAndFlags home_key;
	private final CountsAndFlags minus_key;
	private final CountsAndFlags num_lock_key;
	private final CountsAndFlags period_key;
	private final CountsAndFlags semicolon_key;
	private final CountsAndFlags shift_key;
	private final CountsAndFlags slash_key;
	private final CountsAndFlags space_key;
	private final CountsAndFlags tab_key;
	...
	public void keyPressed(KeyEvent e) {
		...
		// Alphabet keys
		final char key_char = e.getKeyChar();
		char ch_temp;

		ch_temp = 'A';
		for (int i = 0; i < ALPHABET_KEY_NUM; i++) {
			if (key_char == ch_temp) {
				alphabet_keys.SetPressingFlag(i, true);
			}
			ch_temp++;
		}
	...
	public void keyReleased(KeyEvent e) {
		...
		for (int i = 0; i < ALPHABET_KEY_NUM; i++) {
			if (key_char == ch_temp) {
				alphabet_keys.SetPressingFlag(i, false);
			}
			ch_temp++;
		}
