...
public class GLES3Wrapper {
	public static void glActiveTexture(int arg0) {
		...
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glActiveTexture] code:"+code,true);
		}
	}
	public static void glAttachShader(int arg0,int arg1) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glAttachShader] code:"+code,true);
		}
	}
	...
	public static void glBindVertexArray(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glBindVertexArray] code:"+code,true);
		}
	}
	public static void glBlendFunc(int arg0,int arg1) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glBlendFunc] code:"+code,true);
		}
	}
	public static void glBufferData(int arg0,long arg1,Buffer arg2,int arg3) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glBufferData] code:"+code,true);
		}
	}
	public static void glClear(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glClear] code:"+code,true);
		}
	}
	...
	public static void glCompileShader(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glCompileShader] code:"+code,true);
		}
	}
	public static int glCreateProgram() {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glCreateProgram] code:"+code,true);
		}
	...
	public static int glCreateShader(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glCreateShader] code:"+code,true);
		}
	...
	public static void glCullFace(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glCullFace] code:"+code,true);
		}
	}
	public static void glDeleteBuffers(int arg0,IntBuffer arg1) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glDeleteBuffers] code:"+code,true);
		}
	}
	public static void glDeleteShader(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glDeleteShader] code:"+code,true);
		}
	}
	public static void glDeleteVertexArrays(int arg0,IntBuffer arg1) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glDeleteVertexArrays] code:"+code,true);
		}
	}
	public static void glDepthFunc(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glDepthFunc] code:"+code,true);
		}
	}
	public static void glDepthMask(boolean arg0) {
		GLES3 gles3=GLContext.getCurrentGL().getGLES3();
		gles3.glDepthMask(arg0);
		
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glDepthMask] code:"+code,true);
		}
	}
	public static void glDisable(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glDisable] code:"+code,true);
		}
	}
	public static void glDisableVertexAttribArray(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glDisableVertexAttribArray] code:"+code,true);
		}
	}
	...
	public static void glDrawElements(int arg0,int arg1,int arg2,int arg3) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glDrawElements] code:"+code,true);
		}
	}
	public static void glEnable(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glEnable] code:"+code,true);
		}
	}
	public static void glEnableVertexAttribArray(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glEnableVertexAttribArray] code:"+code,true);
		}
	}
	...
	public static void glGenVertexArrays(int arg0,IntBuffer arg1) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glGenVertexArrays] code:"+code,true);
		}
	}
	public static void glGetProgramInfoLog(int arg0,int arg1,IntBuffer arg2,ByteBuffer arg3) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glGetProgramInfoLog] code:"+code,true);
		}
	}
	public static void glGetProgramiv(int arg0,int arg1,IntBuffer arg2) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glGetProgramiv] code:"+code,true);
		}
	}
	public static void glGetShaderInfoLog(int arg0,int arg1,IntBuffer arg2,ByteBuffer arg3) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glGetShaderInfoLog] code:"+code,true);
		}
	}
	public static void glGetShaderiv(int arg0,int arg1,IntBuffer arg2) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glGetShaderiv] code:"+code,true);
		}
	}
	public static int glGetUniformLocation(int arg0,String arg1) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glGetUniformLocation] code:"+code,true);
		}
	...
	public static void glSamplerParameteri(int arg0,int arg1,int arg2) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glSamplerParameteri] code:"+code,true);
		}
	}
	...
	public static void glTexParameteri(int arg0,int arg1,int arg2) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glTexParameteri] code:"+code,true);
		}
	}
	public static void glUniform1f(int arg0,float arg1) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glUniform1f] code:"+code,true);
		}
	}
	public static void glUniform1i(int arg0,int arg1) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glUniform1i] code:"+code,true);
		}
	}
	public static void glUniform3fv(int arg0,int arg1,FloatBuffer arg2) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glUniform3fv] code:"+code,true);
		}
	}
	public static void glUniform4fv(int arg0,int arg1,FloatBuffer arg2) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glUniform4fv] code:"+code,true);
		}
	}
	public static void glUniformMatrix4fv(int arg0,int arg1,boolean arg2,FloatBuffer arg3) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glUniformMatrix4fv] code:"+code,true);
		}
	}
	public static void glUseProgram(int arg0) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glUseProgram] code:"+code,true);
		}
	}
	public static void glVertexAttribPointer(int arg0,int arg1,int arg2,boolean arg3,int arg4,long arg5) {
		...
		int code=gles3.glGetError();
		if(code!=GLES3.GL_NO_ERROR) {
			LogFile.WriteTrace("[GLES3Wrapper-glVertexAttribPointer] code:"+code,true);
		}
	}
}
