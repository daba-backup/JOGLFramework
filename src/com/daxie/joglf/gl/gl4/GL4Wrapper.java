...
public class GL4Wrapper {
	...
	public static void glBindBuffer(int arg0,int arg1) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glBindBuffer] code:"+code,true);
		}
	}
	public static void glBindSampler(int arg0,int arg1) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glBindSampler] code:"+code,true);
		}
	}
	public static void glBindVertexArray(int arg0) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glBindVertexArray] code:"+code,true);
		}
	}
	public static void glBlendFunc(int arg0,int arg1) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glBlendFunc] code:"+code,true);
		}
	}
	public static void glBufferData(int arg0,long arg1,Buffer arg2,int arg3) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glBufferData] code:"+code,true);
		}
	}
	public static void glClear(int arg0) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glClear] code:"+code,true);
		}
	}
	...
	public static int glCreateShader(int arg0) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glCreateShader] code:"+code,true);
		}
	...
	public static void glCullFace(int arg0) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glCullFace] code:"+code,true);
		}
	}
	...
	public static void glDeleteVertexArrays(int arg0,IntBuffer arg1) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glDeleteVertexArrays] code:"+code,true);
		}
	}
	public static void glDepthFunc(int arg0) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glDepthFunc] code:"+code,true);
		}
	}
	public static void glDisableVertexAttribArray(int arg0) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glDisableVertexAttribArray] code:"+code,true);
		}
	}
	public static void glDrawArrays(int arg0,int arg1,int arg2) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glDrawArrays] code:"+code,true);
		}
	}
	public static void glDrawElements(int arg0,int arg1,int arg2,int arg3) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glDrawElements] code:"+code,true);
		}
	}
	public static void glEnable(int arg0) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glEnable] code:"+code,true);
		}
	}
	public static void glEnableVertexAttribArray(int arg0) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glEnableVertexAttribArray] code:"+code,true);
		}
	}
	public static void glFlush() {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glFlush] code:"+code,true);
		}
	}
	public static void glGenBuffers(int arg0,IntBuffer arg1) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glGenBuffers] code:"+code,true);
		}
	}
	public static void glGenSamplers(int arg0,IntBuffer arg1) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glGenSamplers] code:"+code,true);
		}
	}
	...
	public static int glGetUniformLocation(int arg0,String arg1) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glGetUniformLocation] code:"+code,true);
		}
	...
	public static void glTexParameteri(int arg0,int arg1,int arg2) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glTexParameteri] code:"+code,true);
		}
	}
	public static void glUniform1f(int arg0,float arg1) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glUniform1f] code:"+code,true);
		}
	}
	public static void glUniform1i(int arg0,int arg1) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glUniform1i] code:"+code,true);
		}
	}
	public static void glUniform3fv(int arg0,int arg1,FloatBuffer arg2) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glUniform3fv] code:"+code,true);
		}
	}
	public static void glUniform4fv(int arg0,int arg1,FloatBuffer arg2) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glUniform4fv] code:"+code,true);
		}
	}
	...
	public static void glUseProgram(int program_id) {
		...
		int code=gl4.glGetError();
		if(code!=GL4.GL_NO_ERROR) {
			LogFile.WriteError("[GL4Wrapper-glUseProgram] code:"+code,true);
		}
	}
