...
public class GL3Wrapper {
	public static void glActiveTexture(int arg0) {
		...
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glActiveTexture] code:"+code,true);
		}
	}
	public static void glAttachShader(int arg0,int arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glAttachShader] code:"+code,true);
		}
	}
	public static void glBindBuffer(int arg0,int arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glBindBuffer] code:"+code,true);
		}
	}
	public static void glBindSampler(int arg0,int arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glBindSampler] code:"+code,true);
		}
	}
	public static void glBindVertexArray(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glBindVertexArray] code:"+code,true);
		}
	}
	public static void glBlendFunc(int arg0,int arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glBlendFunc] code:"+code,true);
		}
	}
	public static void glBufferData(int arg0,long arg1,Buffer arg2,int arg3) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glBufferData] code:"+code,true);
		}
	}
	public static void glClear(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glClear] code:"+code,true);
		}
	}
	public static void glClearColor(float arg0,float arg1,float arg2,float arg3) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glClearColor] code:"+code,true);
		}
	}
	public static void glCompileShader(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glCompileShader] code:"+code,true);
		}
	}
	public static int glCreateProgram() {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glCreateProgram] code:"+code,true);
		}
	...
	public static int glCreateShader(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glCreateShader] code:"+code,true);
		}
	...
	public static void glCullFace(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glCullFace] code:"+code,true);
		}
	}
	public static void glDeleteBuffers(int arg0,IntBuffer arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glDeleteBuffers] code:"+code,true);
		}
	}
	public static void glDeleteShader(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glDeleteShader] code:"+code,true);
		}
	}
	public static void glDeleteVertexArrays(int arg0,IntBuffer arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glDeleteVertexArrays] code:"+code,true);
		}
	}
	...
	public static void glDisable(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glDisable] code:"+code,true);
		}
	}
	public static void glDisableVertexAttribArray(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glDisableVertexAttribArray] code:"+code,true);
		}
	}
	public static void glDrawArrays(int arg0,int arg1,int arg2) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glDrawArrays] code:"+code,true);
		}
	}
	public static void glDrawElements(int arg0,int arg1,int arg2,int arg3) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glDrawElements] code:"+code,true);
		}
	}
	public static void glEnable(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glEnable] code:"+code,true);
		}
	}
	public static void glEnableVertexAttribArray(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glEnableVertexAttribArray] code:"+code,true);
		}
	}
	public static void glFlush() {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glFlush] code:"+code,true);
		}
	}
	public static void glGenBuffers(int arg0,IntBuffer arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glGenBuffers] code:"+code,true);
		}
	}
	public static void glGenSamplers(int arg0,IntBuffer arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glGenSamplers] code:"+code,true);
		}
	}
	public static void glGenVertexArrays(int arg0,IntBuffer arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glGenVertexArrays] code:"+code,true);
		}
	}
	public static void glGetProgramInfoLog(int arg0,int arg1,IntBuffer arg2,ByteBuffer arg3) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glGetProgramInfoLog] code:"+code,true);
		}
	}
	public static void glGetProgramiv(int arg0,int arg1,IntBuffer arg2) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glGetProgramiv] code:"+code,true);
		}
	}
	public static void glGetShaderInfoLog(int arg0,int arg1,IntBuffer arg2,ByteBuffer arg3) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glGetShaderInfoLog] code:"+code,true);
		}
	}
	public static void glGetShaderiv(int arg0,int arg1,IntBuffer arg2) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glGetShaderiv] code:"+code,true);
		}
	}
	public static int glGetUniformLocation(int arg0,String arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glGetUniformLocation] code:"+code,true);
		}
	...
	public static void glLinkProgram(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glLinkProgram] code:"+code,true);
		}
	}
	public static void glSamplerParameteri(int arg0,int arg1,int arg2) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glSamplerParameteri] code:"+code,true);
		}
	}
	public static void glShaderSource(int arg0,int arg1,String[] arg2,IntBuffer arg3) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glShaderSource] code:"+code,true);
		}
	}
	public static void glTexParameteri(int arg0,int arg1,int arg2) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glTexParameteri] code:"+code,true);
		}
	}
	public static void glUniform1f(int arg0,float arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glUniform1f] code:"+code,true);
		}
	}
	public static void glUniform1i(int arg0,int arg1) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glUniform1i] code:"+code,true);
		}
	}
	public static void glUniform3fv(int arg0,int arg1,FloatBuffer arg2) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glUniform3fv] code:"+code,true);
		}
	}
	public static void glUniform4fv(int arg0,int arg1,FloatBuffer arg2) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glUniform4fv] code:"+code,true);
		}
	}
	public static void glUniformMatrix4fv(int arg0,int arg1,boolean arg2,FloatBuffer arg3) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glUniformMatrix4fv] code:"+code,true);
		}
	}
	public static void glUseProgram(int arg0) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glUseProgram] code:"+code,true);
		}
	}
	public static void glVertexAttribPointer(int arg0,int arg1,int arg2,boolean arg3,int arg4,long arg5) {
		...
		int code=gl3.glGetError();
		if(code!=GL3.GL_NO_ERROR) {
			LogFile.WriteWarn("[GL3Wrapper-glVertexAttribPointer] code:"+code,true);
		}
	}
}
